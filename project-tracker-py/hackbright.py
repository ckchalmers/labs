...
def assign_grade(github, title, grade):
    ...
    QUERY="""
        INSERT INTO grades (grade, project_title, student_github)
        VALUES (:grade, :project_title, :student_github)
    """
    ...
    print(f"Successfully added entry: {github} {title} {grade}")
